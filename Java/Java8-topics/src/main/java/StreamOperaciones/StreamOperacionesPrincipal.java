...
public class StreamOperacionesPrincipal {
    public static void main(String[] args) {
        ...
        ArrayList<LocalDate> arrayListLocalDate = new ArrayList();
        
        arrayList.add(new Persona("Brenda",LocalDate.now(), "MX"));
        arrayList.add(new Persona("Claudia",LocalDate.of(1990, Month.MARCH, 10), "CDMX"));
        arrayList.add(new Persona("Alonso",LocalDate.of(2018, Month.DECEMBER, 19), "CH"));
        arrayList.add(new Persona("Mario",LocalDate.of(2000, Month.DECEMBER, 20), "JP"));
        arrayList.add(new Persona("Manuel",LocalDate.of(1989, Month.JANUARY, 30), "MX"));
        arrayList.add(new Persona("Gabriel",LocalDate.of(2005, Month.OCTOBER, 8), "MX"));
        arrayList.add(new Persona("Gabriel",LocalDate.of(2005, Month.MAY, 8), "AR"));
