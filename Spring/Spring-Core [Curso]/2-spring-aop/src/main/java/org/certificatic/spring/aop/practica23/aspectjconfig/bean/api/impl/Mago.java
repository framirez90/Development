...
public class Mago implements IAdivinador {
	...
	// el argumento
	@Pointcut("execution(* org.certificatic.spring.aop.practica23..IVoluntario.pensar*(String)) "
			+ "&& args(pensamiento)")
	...
	// argumento
	@Pointcut(value = "execution(* org.certificatic.spring.aop.practica23..IVoluntario.getP*(boolean)) "
			+ "&& args(x)", argNames="x")
