...
@ContextConfiguration(locations = { MethodInjectionWithAnnotationsTest.location })
public class MethodInjectionWithAnnotationsTest {

	public static final String location = "classpath:/spring/practica21/method-injection-context-with-annotations.xml";
