...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public void arraysSpelTest() {
		...
		String invention_2 = (String) spelParser.parseExpression(
				"inventions[2]").getValue(teslaContext); // definir expresión que corresponda con obtener el valor del invento posición 2 de Tesla
	...
	public void listSpelTest() {
		...
		Inventor teslaInventor = (Inventor) spelParser.parseExpression(
				"members[2]").getValue(societyContext); // definir expresión que corresponda con obtener el valor del miembro posición 2 del contexto society
		...
		String inventionName_1 = (String) spelParser.parseExpression(
				"getMembers()[2].getInventions()[1]").getValue(societyContext); // utilizando el contexto society, obtener el nombre del invento posición 1 del miembro posición 2, obtener utilizando el nombre de la función
		...
		String otherInventionName_1 = (String) spelParser.parseExpression(
				"members[2].inventions[1]").getValue(societyContext); // utilizando el contexto society, obtener el nombre del invento posición 1 del miembro posición 2, obener utilizando posición en el arreglo
	...
	public void inlineListSpelTest() {
		...
		List<Integer> listOfIntegers = (List<Integer>) spelParser.parseExpression(
				"{1,2,3,4}").getValue(); // definir y obtener el valor de una expresión que corresponda a la definición de una lista de enteros del 1 al 4
		...
		List<List<String>> listOfListOfStrings = (List<List<String>>) spelParser.parseExpression(
				"{{'a','b'},{'c', 'd'}}").getValue(); // definir y obtener el valor de una expresión que corresponda a la definición de una lista de listas de strings
